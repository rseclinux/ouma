...
## Don't
We are highly against the usage of code in the libc that has been blatantly "copy-pasted" from AI/LLM chat bots without reviewing it, refractoring and properly testing it. ALL AI contributions without proper attribution to chat bots and/or other types of LLM/AI WILL be denied and if someone will keep on pushing such pull requests, patches then this person WILL be banned from project.
